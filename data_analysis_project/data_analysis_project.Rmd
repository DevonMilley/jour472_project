...
* **Analysis summary**: Our analysis of this question is the most effective of the three, and its findings will be helpful in guiding the rest of our project. To answer it, we grouped by holc_grade then summarised the mean percentage populations of each race in accordance with HOLC letter grades. The results showed more diversity than we anticipated in the 'A' HOLC grade (we expected very little, following the bias history that created the grading criteria), with the average white percentage at 73.78 percent and average Black and Hispanic percentages hovering just under 9 percent. Aside from the percent white mean, other averages grew larger and subsequently more diverse as the HOLC letter grade decreased.
